...
def create_dict_word_count(path_to_files) :
	...
	fp1 = open(path_to_files+"suffix_dict_with_counts.json")
...
def cal_pmi(path_to_files):
	...
	with open(path_to_files+"derived_words_pmi.json","wb+") as f :
		json.dump(dict_pmi,f)		

	print len(dict_pmi),"derived_words"	
	############################################# SOURCE WORDS ##################################################################
	...
	print len(dict_pmi),"source_words"
	with open(path_to_files+"source_word_pmi.json","wb+") as f:
		json.dump(dict_pmi,f)
	...
	print len(dict_pmi),"affixes"

	with open(path_to_files+"suffix_pmi.json","wb+") as f :
		json.dump(dict_pmi,f)
"""
	for derived_word,ind_count in derived_word_count.iteritems():
		for context_word, mutual_count in derived_co_occurence_dict[derived_word].iteritems():
	...
	with open("suffix_pmi.json","wb+") as f:
		json.dump(dict_pmi,f)

"""	
if __name__ == "__main__" : 
	
	cal_pmi("/home/du3/13CS30045/affix_final/lazaridou/create_vectors/data_files/")
